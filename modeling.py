...
XBC = XGBClassifier(booster = 'gbtree',learning_rate =0.01,
...
# evaluate model
# y_train_pred1 = classifier_XBC.predict(X)
# y_pred1 = classifier_XBC.predict(X_test)
# train_mse1 = mean_squared_error(y_train_pred1, y)
# # test_mse1 = mean_squared_error(y_pred1, Y_test)
# train_rmse1 = np.sqrt(train_mse1)
# # test_rmse1 = np.sqrt(test_mse1)
# print('Train RMSE: %.4f' % train_rmse1)
# # print('Test RMSE: %.4f' % test_rmse1)
print(classifier_XBC.score(X_test,Y_test))
